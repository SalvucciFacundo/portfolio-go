...
func MockData() domain.Profile {
	return domain.Profile{
		...
		Skills: []domain.Skill{
			{Name: "Go", LevelEs: "Avanzado", LevelEn: "Advanced", IconURL: devicon + "/go/go-original.svg"},
			{Name: "templ", LevelEs: "Intermedio", LevelEn: "Intermediate", IconURL: "https://placehold.co/64x64/1A1A1A/F4F4F2?text=t"},
			{Name: "HTMX", LevelEs: "Intermedio", LevelEn: "Intermediate", IconURL: devicon + "/htmx/htmx-original.svg"},
			{Name: "PostgreSQL", LevelEs: "Intermedio", LevelEn: "Intermediate", IconURL: devicon + "/postgresql/postgresql-original.svg"},
			{Name: "Docker", LevelEs: "Intermedio", LevelEn: "Intermediate", IconURL: devicon + "/docker/docker-original.svg"},
			{Name: "TypeScript", LevelEs: "Avanzado", LevelEn: "Advanced", IconURL: devicon + "/typescript/typescript-original.svg"},
			{Name: "Angular", LevelEs: "Avanzado", LevelEn: "Advanced", IconURL: devicon + "/angular/angular-original.svg"},
			{Name: "Git", LevelEs: "Avanzado", LevelEn: "Advanced", IconURL: devicon + "/git/git-original.svg"},
		},
