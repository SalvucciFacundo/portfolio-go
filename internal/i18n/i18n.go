...
var translations = map[string]map[string]string{
	"es": {
		...
		"contact.error_rate":          "Demasiados intentos, esperá un momento.",
		"contact.error_send":          "No se pudo enviar el mensaje, intentá de nuevo más tarde.",
	...
	"en": {
		...
		"contact.error_rate":          "Too many attempts, please wait a moment.",
		"contact.error_send":          "Could not send the message, please try again later.",
